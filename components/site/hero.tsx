...
export function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-border">
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-brand/[0.07] via-transparent to-transparent" />
      ...
      <div className="container relative py-20 md:py-28">
        <div className="max-w-3xl">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/inventory"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-brand px-7 text-[15px] font-semibold text-brand-foreground transition-colors hover:bg-brand/90"
            >
              Explore inventory
